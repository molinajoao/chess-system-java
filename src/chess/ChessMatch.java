...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		Position source = sourcePosition.toPosition(); // convertando para a posição da matriz
		Position target = targetPosition.toPosition();
		validateSourcePosition(source);// isso serve para validar se já mesmo uma peça nessa posição
		...
		return (ChessPiece) capturedPiece; // downcasting para ChessPiece pois a peça capturada era um Piece
	}
